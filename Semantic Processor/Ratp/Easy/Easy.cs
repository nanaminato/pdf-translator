...
public class Easy
{
    public static void Output()
    {
        ...
        // var path = @"C:\Users\betha\Desktop\毕业设计\PDF 翻译大师\code_pdf2htmlex2.html";
        ...
        //
        // var pageHtmls = new List<string>() { };
        // foreach (var htmlPage in page)
        // {
        //     var pfx = DivHelpSelector.Select(htmlPage.Document, "div");
        //     var pfxText = pfx.OuterHtml;
        //     var pxc = new PageComposer(styleNode, pfxText,null);
        //     var pageHtml = pxc.Compose();
        //     pageHtmls.Add(pageHtml);
        // }
        //
        // var htmlhtml = composer.OutHtmlOneStep(pageHtmls);
        //
        // // var htmlhtml = composer.OutHtmlOneStep(new List<string>(){pageHtml});
        // File.WriteAllText(@"C:\Users\betha\Desktop\毕业设计\PDF 翻译大师\out.html",
        //     $"{htmlhtml}");
